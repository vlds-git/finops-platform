...
if docker-compose -f deploy/docker/docker-compose.yml ps &>/dev/null; then
...
for endpoint in   "http://localhost:8080/health:API Gateway"   "http://localhost:8081/health:Ingestion"   "http://localhost:8082/health:Cost Analytics"   "http://localhost:8083/health:Alert Manager"   "http://localhost:8001/health:Forecast"   "http://localhost:8002/health:Anomaly"   "http://localhost:8003/health:Recommendation"; do
